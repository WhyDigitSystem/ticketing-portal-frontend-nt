...
const Dashboard = () => {
  ...
  const stats = [
    {
      ...
      color:
        "from-blue-600/20 to-blue-500/5 border-blue-500/20 text-blue-400",
    },
    {
      title: "Completed",
    ...
    },
    {
      ...
      icon: AlertTriangle,
      color:
        "from-red-600/20 to-rose-500/5 border-red-500/20 text-red-400",
    },
    {
      title: "Quick Access",
      isQuickAccess: true,
  ...
  const topEmployees = useMemo(() => {
    ...
    return sortedEmployees.map((emp) => ({
      ...emp,
      progress: `${totalTickets
        ? Math.round((emp.tickets / totalTickets) * 100)
        : 0
        }%`,
    }));
          ...
          {recentTickets.map((ticket, index) => (
            ...
            >
              ...
              <td className="py-3 text-xs text-gray-900 dark:text-white">
                <div className="max-w-[220px] truncate" title={ticket.title}>
                  {ticket.title}
                </div>
              </td>
