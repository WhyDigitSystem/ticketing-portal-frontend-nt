  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 px-3 animate-fadeIn">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mb-3 overflow-hidden rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-3">
        ...
        ">
                  ...
                  <div className="p-2 flex flex-col gap-1.5">
                    ...
                    {/* ICON (smaller) */}
                    <div className={`w-6 h-6 rounded-md bg-gradient-to-br ${item.color} flex items-center justify-center text-white`}>
